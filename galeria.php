    ...
    <div id="content">
    	<div id="gallerycontainer">
			<ul class="portfolio-categ filter">
				<li>Opciones de Bus:</li>
				<li class="all active"><a href="#">Todas</a></li>
				<li class="cat-item-1"><a href="#" title="Category 1">Cama</a></li>
				<li class="cat-item-2"><a href="#" title="Category 2">Semi Cama</a></li>
				<li class="cat-item-3"><a href="#" title="Category 3">Normal</a></li>
				<li class="cat-item-4"><a href="#" title="Category 4">Minibus</a></li>
			</ul>
			<ul class="portfolio-area" style="width: 860px;">			              			
			        ...
			        <div>
						...
						<a class="image-zoom" href="img/1.jpg" rel="prettyPhoto[gallery]" ><img width="225" height="140" src="img/1.jpg"  />                    
                   		...
                   		<div class="home-portfolio-text">
							<h2 class="post-title-portfolio"><a href="#" rel="bookmark" >Bus Cama</a></h2>
                    		<p class="post-subtitle-portfolio">Lo mejor !!!</p>
						</div>
                    </div>	
                </li>	
                ...
                <li class="portfolio-item2" data-id="id-1" data-type="cat-item-2">	
			       <div>
                   		...
                   		<div class="home-portfolio-text">
							<h2 class="post-title-portfolio"><a href="#" rel="bookmark" title="Up">Bus Semicama</a></h2>
                    		<p class="post-subtitle-portfolio">Comodos !!!</p>
						</div>
            	...
            	<li class="portfolio-item2" data-id="id-9" data-type="cat-item-2">	
			        <div>
						...
						<a class="image-zoom" href="img/6.jpg" rel="prettyPhoto[gallery]" ><img width="225" height="140" src="img/6.jpg"  />                    
                   		...
                   		<div class="home-portfolio-text">
							<h2 class="post-title-portfolio"><a href="#" rel="bookmark" >Bus Semicama</a></h2>
                    		<p class="post-subtitle-portfolio">Comodos !!!</p>
						</div>                   
					</div>	
                </li>
			        ...
			        <div>
						...
						<a class="image-zoom" href="img/9.jpg" rel="prettyPhoto[gallery]" ><img width="225" height="140" src="img/9.jpg"  /> </a>
                   		...
                   		<div class="home-portfolio-text">
                    		...
                    		<p class="post-subtitle-portfolio">Accesibles!!!</p>
						</div>                    
					</div>	
                </li>	
                ...
                <li class="portfolio-item2" data-id="id-4" data-type="cat-item-3">	
			        <div>
						...
						<a class="image-zoom" href="img/10.jpg" rel="prettyPhoto[gallery]" ><img width="225" height="140" src="img/10.jpg" />                    
                   		...
                   		<div class="home-portfolio-text">
							<h2 class="post-title-portfolio"><a href="#" rel="bookmark">Bus Normal</a></h2>
                    		<p class="post-subtitle-portfolio">Accesibles!!!</p>
						</div>                   
					</div>	
                </li>	
		        ...
		        <li class="portfolio-item2" data-id="id-11" data-type="cat-item-4">	
			        <div>
						...
						<a class="image-zoom" href="img/13.jpg" rel="prettyPhoto[gallery]"><img width="225" height="140" src="img/13.jpg"  />                    
                   		...
                   		<div class="home-portfolio-text">
							<h2 class="post-title-portfolio"><a href="#" rel="bookmark" >Minibus</a></h2>
                    		<p class="post-subtitle-portfolio">En el momento!!!</p>
						</div>                    
					</div>	
                </li>
			    ...
			    <div>
                   <span class="image-block">
					<a class="image-zoom" href="img/14.jpg" rel="prettyPhoto[gallery]" title="Wall-E"><img width="225" height="140" src="img/14.jpg" alt="Wall-E" title="Wall-E" />                    
                   	...
                   	<div class="home-portfolio-text">
						<h2 class="post-title-portfolio"><a href="#" rel="bookmark" title="Wall-E">Minibus</a></h2>
                    	<p class="post-subtitle-portfolio">En el momento!!!</p>
					</div>
