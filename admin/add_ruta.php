...
<form action="add_admin.php" method="post">
	Tipo de bus:<br><input type="text" name="type" class="ed"><br>
	ruta:<br><input type="text" name="route" class="ed"><br>
	precio:<br><input type="text" name="price" class="ed"><br>
	Numero de asiento:<br><input type="text" name="seat" class="ed"><br>
	Tiempo:<br><input type="text" name="time" class="ed" placeholder="10:30am"><br>
