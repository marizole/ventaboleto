...
<div id="wrapper">
  <div id="header">
    ...
    <div id="featured">
        <div id="items">
            <div class="item"> <a href="#"><mg src="xres/images/1.jpg" width="200" height="120" alt="" /></a>
            <h3><a href="#">Ofertas</a></h3>
            <p><a href="#"><strong>Bus Cama</strong><br />
      Vive algo nuevo<br /> Nuevos autobuses <br /> Todos los dias!</a></p>  
            </div>
            <div class="item"> <a href="#"><img src="xres/images/2.jpg" width="200" height="120" alt="" /></a>
            <h3><a href="#">Nuevas Rutas</a></h3>
            <p><a href="#"><strong>De La Paz a Sucre y Viceversa</strong><br />
      Pase una velada relajante en nuestro Hotel de Valle Grande, lleno de historia. </a></p>  
      </div>
  ...
  <div id="footer">
  <h2>+59175250201 &bull; <a href="#"> Asociacion de Transporte Libre (ATL) - Marizol & Ramon</a></h2>
